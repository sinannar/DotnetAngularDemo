...
using DotnetAngularDemo.Authentication.JwtBearer;
...
namespace DotnetAngularDemo.Web.Host.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "DotnetAngularDemo API", Version = "v1" });
            ...
            return services.AddAbp<DotnetAngularDemoWebHostModule>(
